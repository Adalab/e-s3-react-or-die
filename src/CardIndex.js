                            ...
                            <ul className="themes">
                                <li>
                                    <label for="colors" className="theme default">
                                        ...
                                        <div className="colors__list" style="background-color:#114e4e"></div>
                                        <div className="colors__list" style="background-color:#438792;"></div>
                                        <div className="colors__list" style="background-color: #a2deaf"></div>
                                    </label>
                                </li>
                                <li>
                                    <label for="colors" className="theme orange">
                                        <input type="radio" id="warm" name="colors" className="radio" value="2"/>
                                        <div className="colors__list" style="background-color: #420101"></div>
                                        <div className="colors__list" style="background-color: #bd1010"></div>
                                        <div className="colors__list" style="background-color: #e95626"></div>
                                    </label>
                                </li>
                                <li>
                                    <label for="colors" className="theme blue">
                                        <input type="radio" id="formal" name="colors" className="radio" value="3"/>
                                        <div className="colors__list" style="background-color: #3e5b65"></div>
                                        <div className="colors__list" style="background-color: #dfe5eb"></div>
                                        <div className="colors__list" style="background-color: #a0c0cf"></div>
                                    </label>
                                </li>
                            </ul>
                        </div>
